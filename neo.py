...
import parcours_csv
from Chenapandas.Application import Application
...
def import_files(app):
    ...
    #FIRST CSV
    infos, val = collect_infos_leads("../Chenapandas/Chenapandas/Liste_leads.csv")
    ...
    #SECOND Json
    infos, val = collect_infos_sherpa("../Chenapandas/Chenapandas/sherpas.json")
